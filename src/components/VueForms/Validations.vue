    ...
    <form class="form-horizontal" @submit.prevent="Signup">
      ...
      <div class="form-group" :class="{ invalid: $v.UserSigup.age.$error }">
        ...
        <div class="col-sm-10">
          ...
          />
          <p class="p-tag" v-if="!$v.UserSigup.age.minvalu">
            you have to be at least{{ $v.UserSigup.age.$params.minvalu.min }}
            year old
          </p>
      ...
      <div
        class="form-group"
        :class="{ invalid: $v.UserSigup.password.$error }"
      >
        ...
        <div class="col-sm-10">
          ...
          />
          <p class="p-tag" v-if="!$v.UserSigup.password.minLen">
            password must to be at least{{
              $v.UserSigup.password.$params.minLen.min
            }}
            character
          </p>
        </div>
      ...
      <div
        class="form-group"
        :class="{ invalid: $v.UserSigup.confpassword.$error }"
      >
        <label for="inputPasswo" class="col-sm-2 control-label"
        ...
        <div class="col-sm-10">
          ...
          />
          <p class="p-tag" v-if="!$v.UserSigup.confpassword.$invalid == false">
            confirm password must to be same As password
          </p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-6">
          <app-switch v-model="UserSigup.dataSwitch"></app-switch>
        </div>
      </div>
      <div class="form-group">
      ...
      <div
        class="form-group"
        :class="{ invalid: $v.UserSigup.termcondtion.$invalid }"
      >
        <div class="col-sm-offset-2 col-sm-10">
          <div class="checkbox">
...
export default {
  ...
  methods: {
    Signup() {
      console.log(this.UserSigup.dataSwitch);
    },
    add(index) {
      console.log(index);
